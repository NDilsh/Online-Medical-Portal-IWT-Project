 ...
 $host = "localhost";
    ...
    $dbname = "special events";
     ...
     die('Connect Error('. mysqli_connect_errno().')'. mysqli_connect_error());
	  ...
	  $SELECT = "SELECT Phone_Number From eye_donetion Where Phone_number = ? Limit 1";
	  
	  $INSERT = "INSERT Into eye_donetion ( F_Name,L_Name,Age,Weight,Phone_Number,Gender) values(?, ?, ?, ?, ?, ?)";
